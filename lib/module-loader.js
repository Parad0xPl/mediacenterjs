...
const express = require('express'),
      fs = require('fs-extra'),
      path = require('path'),
      pug = require('pug'), // jshint ignore:line
...
const initModule = function(modulePath, parent){// jshint ignore:line
  ...
  mcmodule.tileSize = modulePackage.mcmodule_tileSize || "1";
  mcmodule.priority = modulePackage.mcmodule_priority || 0;
  ...
  mcmodule.app.set(`view engine`, "pug");
