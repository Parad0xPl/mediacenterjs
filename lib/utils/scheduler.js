...
exports.schedule = function() {
    ...
    if (config.schedule) {
        ...
        if (fs.existsSync('../lib/database/mcjs-sqlite-journal') === false) {
            ...
            var movie_metadata = require('../../modules/movies/metadata-processor');
            var tv_metadata = require('../../modules/tv/metadata-processor');
            var music_metadata = require('../../modules/music/metadata-processor');
